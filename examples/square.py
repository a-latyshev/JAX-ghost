"""Scalar P1/P2/P3 forward updates on a triangular unit-square mesh.

Run with: JAX_PLATFORMS=cpu mpirun -n 2 python examples/square.py
"""
...
def main():
    ...
    # The same IndexMap-based scatterer works for both interval and square meshes.
    with JAXGhost.from_index_map(
        ...
        if comm.rank == 0:
            print(f"Square P{args.degree} field matches owners and DOLFINx", flush=True)
